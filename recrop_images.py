...
from TDDFA_V2.utils.pose import calc_pose, P2sRt, matrix2angle
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input_path', type=str, default='./TDDFA_V2/examples/test/data.pkl')
    parser.add_argument('-o', '--output', type=str, default='./TDDFA_V2/examples/test/quads.pkl')
    parser.add_argument('-j', '--output_json', type=str, default='dataset.json')
    parser.add_argument('-p', '--prefix', type=str, default='')
    parser.add_argument('--size', type=int, default=1024)
    parser.add_argument('--out_dir', type=str, default='./TDDFA_V2/examples/test/crop_samples/img')
    parser.add_argument('--mode', type=str, default='gpu', help='gpu or cpu mode')
    parser.add_argument('--config', type=str, default='./TDDFA_V2/configs/mb1_120x120.yml')
