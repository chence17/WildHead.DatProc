...
def main():
    ...
    print(f'Done. Take ({(1E3 * (t2 - t1) / 100):.1f}ms) for running per inference.')
    print(f'Done. Take ({(1E3 * (t3 - t2) / 100):.1f}ms) for running on gpu per inference.')
