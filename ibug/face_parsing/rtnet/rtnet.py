...
from ibug.roi_tanh_warping import roi_tanh_polar_to_roi_tanh, roi_tanh_to_roi_tanh_polar
...
class HybridBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv_polar = nn.Sequential(
            conv3x3(group_width, group_width, stride=stride, groups=cardinality, dilation=dilation, mix_padding=True),
            norm_layer(group_width),
        )
        self.conv_cart = nn.Sequential(
            conv3x3(group_width, group_width, stride=stride, groups=cardinality, dilation=dilation, mix_padding=False),
            norm_layer(group_width),
        )
