...
Date: 2023-03-27 14:18:31
LastEditors: chence antonio.chan.cc@outlook.com
LastEditTime: 2023-03-27 14:24:59
FilePath: /DataProcess/ibug/face_parsing/parser.py
...
from ibug.face_parsing.rtnet import rtnet50, rtnet101, FCN
from ibug.face_parsing.resnet import Backbone, DeepLabV3Plus
...
WEIGHT = {
    ...
    'resnet50-deeplabv3plus-14':
    (Path(__file__).parent / 'resnet/weights/resnet50-deeplabv3plus-14.torch', 0.5, 0.5, (513, 513)),
}
