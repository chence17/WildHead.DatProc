...
def parse_args():
    ...
    parser.add_argument('-i', '--input_path', type=str, help='path to json metafile', default='/data/PanoHeadData/single_view_hq/dataset.json')
    parser.add_argument('-d', '--dict_file', type=str, default='/home/tianhao/DatProc/temp/dup_per_deg.json')
    parser.add_argument('-o', '--output_path', type=str, help='path to save rebalanced dataset', default='/data/PanoHeadData/single_view_hq/dataset.json')
