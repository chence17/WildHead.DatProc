...
Date: 2023-03-16 17:45:54
LastEditors: chence antonio.chan.cc@outlook.com
LastEditTime: 2023-03-16 17:46:34
FilePath: /DataProcess/utils/msimil.py
Description: Modified from https://github.com/caprieldeluca/simil
'''
# -*- coding: utf-8 -*-
"""
...
def _get_q_matrix(quaternions):
    q_matrix = [[[q[3], -q[2], q[1], q[0]], [q[2], q[3], -q[0], q[1]], [-q[1], q[0], q[3], q[2]],
                 [-q[0], -q[1], -q[2], q[3]]] for q in quaternions]
    return np.array(q_matrix)


def _get_w_matrix(quaternions):
    w_matrix = [[[q[3], q[2], -q[1], q[0]], [-q[2], q[3], q[0], q[1]], [q[1], -q[0], q[3], q[2]],
                 [-q[0], -q[1], -q[2], q[3]]] for q in quaternions]
...
def process(source_points, target_points, alpha_0=None, scale=True, lambda_0=1.0):
    ...
    blc_matrix, d_matrix, beta_1, r_quat, lambda_i, i = _get_solution(a_matrix, b_scalar, b_matrix, c_scalar, c_matrix,
                                                                      scale, lambda_i, i)
